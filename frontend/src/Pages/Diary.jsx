            ...
            <div className="max-w-7xl mx-auto px-4">
                ...
                >
                    ...
                    <div className="relative z-10 max-w-3xl mx-auto text-center">
                        <div className="inline-flex items-center justify-center w-16 h-16 rounded-2xl bg-[#20AA9D]/10 text-[#20AA9D] mb-6 shadow-sm backdrop-blur-sm bg-white/50 dark:bg-black/20">
                            <FaBook className="text-3xl" />
                        </div>

                        <h1 className="text-3xl md:text-5xl font-bold text-gray-900 dark:text-white mb-4 tracking-tight leading-tight">
                            BSW <span className="text-[#20AA9D]">Diary</span>
                        </h1>

                        <p className="text-lg text-slate-700 dark:text-slate-300 font-medium max-w-2xl mx-auto">
                            Your essential guide to IIT Delhi — curated to help freshers
                            navigate campus life and access vital resources.
                        </p>
                    </div>
                </div>
                ...
                >
                        ...
                        <div className="flex flex-col md:flex-row gap-8 items-center">
                            ...
                            <div className="flex-1 text-center md:text-left">
                                <h2 className="text-2xl font-bold text-gray-900 dark:text-white mb-3">
                                    Student Diary 2024–25
                                </h2>

                                <p className="text-gray-600 dark:text-gray-400 mb-8 leading-relaxed">
                                    A comprehensive handbook covering campus rules, academic
                                    calendar, administrative contacts, and the BSW team directory.
                                </p>

                                {/* Download Button */}
                                <a
                                    href="/misc/bswDiary.pdf"
                                    target="_blank"
                    ...
                    <p className="mt-8 text-center text-sm text-gray-500 dark:text-gray-400">
                        File format: PDF • Approx. 5MB • Updated for current academic session
                    </p>
                </div>
            </div>
        </div>
